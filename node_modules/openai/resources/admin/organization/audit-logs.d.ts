...
export declare class AuditLogs extends APIResource {
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<AuditLogListResponsesPage, AuditLogListResponse>;
    list(options?: {
...
export declare namespace AuditLogListResponse {
     ...
     * The details for events with this `type`.
     */
    interface ExternalStorageRegistered {
        /**
    ...
    namespace ExternalStorageRegistered {
        /**
         * The configuration for the external storage.
         */
        interface Data {
             ...
             */
            provider?: ExternalStorageAPI.AwsExternalStorageProvider | ExternalStorageAPI.AzureExternalStorageProvider | ExternalStorageAPI.GcpExternalStorageProvider;
        }
    }
    /**
     * The details for events with this `type`.
     */
    interface ExternalStorageRemoved {
        /**
         * The ID of the external storage configuration.
         */
        id?: string;
