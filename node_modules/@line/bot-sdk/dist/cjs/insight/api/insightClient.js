...
class InsightClient {
    ...
    async getRichMenuInsightDailyWithHttpInfo(richMenuId, from, to) {
        const requestPath = (0, utils_js_1.buildPath)("/v2/bot/insight/richmenu/{richMenuId}/daily", {
    ...
    async getRichMenuInsightSummaryWithHttpInfo(richMenuId, from, to) {
        const requestPath = (0, utils_js_1.buildPath)("/v2/bot/insight/richmenu/{richMenuId}/summary", {
            richMenuId: richMenuId,
        });
        const queryParams = {
            from: from,
