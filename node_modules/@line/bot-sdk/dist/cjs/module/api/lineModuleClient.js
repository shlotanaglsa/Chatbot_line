...
class LineModuleClient {
    ...
    async acquireChatControlWithHttpInfo(chatId, acquireChatControlRequest) {
        const requestPath = (0, utils_js_1.buildPath)("/v2/bot/chat/{chatId}/control/acquire", {
            chatId: chatId,
        });
    ...
    async releaseChatControlWithHttpInfo(chatId) {
        const requestPath = (0, utils_js_1.buildPath)("/v2/bot/chat/{chatId}/control/release", {
            chatId: chatId,
        });
